...
//  Hour
//
//  Created by Moses Oh on 10/25/18.
    ...
    var post: Post?
    {
        didSet{
            ...
            if let startTime = post?.startTime, let endTime = post?.endTime
            {
                ...
                timeLabel.text = "from " + timeLabel.text! + " - \(endTime)"
...
//            }
    ...
    let dateLabel: UILabel = {
        let a = UILabel()
        a.font = UIFont.init(name: "Helvetica", size: 15)
    ...
    let lineView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(r: 93, g: 125, b: 255)
...
//        self.layer.shadowPath = UIBezierPath(roundedRect: self.bounds, cornerRadius: self.contentView.layer.cornerRadius).cgPath
        ...
        addSubview(lineView)
        lineView.topAnchor.constraint(equalTo: activityLabel.bottomAnchor,constant:5).isActive = true
        lineView.leftAnchor.constraint(equalTo: activityLabel.leftAnchor,constant:5).isActive = true
        lineView.bottomAnchor.constraint(equalTo: eventImageView.bottomAnchor).isActive = true
        ...
        dateLabel.leftAnchor.constraint(equalTo: lineView.rightAnchor, constant: 5).isActive = true
        ...
        timeLabel.leftAnchor.constraint(equalTo: lineView.rightAnchor, constant: 5).isActive = true
        ...
        locationImage.leftAnchor.constraint(equalTo: lineView.rightAnchor, constant: 5).isActive = true
